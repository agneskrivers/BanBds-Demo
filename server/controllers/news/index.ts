...
// Function Type
type ControllerNews = (req: Request<ReqParams>, res: Response<ResJSON>) => void;

const Index: ControllerNews = (req, res) => {
    ...
    const pathImageNews = path.join(pathImages, 'news', image);
